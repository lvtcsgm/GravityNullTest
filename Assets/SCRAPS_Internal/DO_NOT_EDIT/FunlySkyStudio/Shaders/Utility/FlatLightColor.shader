Shader "Funly/Sky Studio/Flat Shading - Light Color"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
			...
			{	
				...
				fixed3 finalColor =  _Ambient / (UNITY_HALF_PI * 2.0f) *_LightIntensity * _LightColor0.xyz * (1.0f - max(0.0f, dot(normal, lightDir)));
